...
public class VoiceChannel {
    ...
    public static void SearchAndPlaySong(JDA jda, String argument, String guildId, String textChannelId,
        ...
        if (argument.isEmpty()){
            channel.sendMessage(TextChannelResponse.NO_ARGUMENT_PROVIDED_TO_PLAY_COMMAND).queue();
            return;
        }
        ...
        if (!audioManager.isConnected()){
            ...
            try {
                ...
                channel.sendMessage(TextChannelResponse.DONT_HAVE_PERMISSION_TO_JOIN_VOICE_CHANNEL).queue();
                return;
            }catch (IllegalArgumentException e){
                channel.sendMessage(TextChannelResponse.NOT_CONNECTED_TO_VOICE_MESSAGE).queue();
                return;
            }
        }
    ...
    public static void setPauseStatusOnAudioPlayer(Guild guild, MessageChannel channel,
        ...
        if (!audioManager.isConnected()){
            channel.sendMessage(TextChannelResponse.BOT_NOT_CONNECTED_TO_VOICE).queue();
