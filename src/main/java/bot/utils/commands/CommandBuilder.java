...
package bot.utils.commands;
        ...
        import bot.utils.commands.Command.CooldownScope;
...
public class CommandBuilder {
    ...
    /**
     * Sets the Command built to be {@link Command#allowedInGuild
     * guild only}.
     *
     ...
     *
     * @param execution The {@link Consumer} that runs on Command#execute(CommandEvent).
     ...
     *
     * @param execution The {@link BiConsumer} that runs on  {@link Command#execute(CommandEvent)}.
     * @return The Command built
     */
