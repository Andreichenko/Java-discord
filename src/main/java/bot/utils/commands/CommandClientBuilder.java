...
import bot.utils.commands.impl.AnnotatedModuleCompilerImpl;
import bot.utils.commands.impl.CommandClientImpl;
...
public class CommandClientBuilder
{
    ...
    public CommandClient build() {
        CommandClient client = new CommandClientImpl(ownerId, coOwnerIds, prefix, altprefix, activity, status, serverInvite,
                ...
                aliasEntityRepository, aliasCreateCommand);
        if (listener != null)
     ...
     *                will use either the default or one provided via
     *                {@link CommandClientBuilder#setHelpConsumer(Consumer)}}.
     * @return This builder
     */
     ...
     * @return This builder
     */
    public CommandClientBuilder setAliasEntityRepository(AliasEntityRepository aliasEntityRepository) {
