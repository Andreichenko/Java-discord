 ...
 */
public class BotCommandEvent implements CommandEvent {
     ...
     */
    public BotCommandEvent(MessageReceivedEvent event, String args, CommandClient client) {
        this.event = event;
     ...
     * automatically does {@link net.dv8tion.jda.api.requests.RestAction#queue() RestAction#queue()}.
     *
     * <p>This method uses {@link MessageChannel#sendFile(File, String, net.dv8tion.jda.api.utils.AttachmentOption...)
     ...
     * this method does not throw a {@link java.io.IOException}. This is because the cause of the alternate String message
     * being sent comes directly from a
