...
public interface CommandClient {
     ...
     * @throws IllegalArgumentException If the Command provided has a name or alias that has already been registered
     */
     ...
     * JDACommand.Module JDACommand.Module} into a {@link List
