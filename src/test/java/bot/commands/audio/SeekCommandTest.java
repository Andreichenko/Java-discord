...
public class SeekCommandTest {
    ...
    public void seekWithHoursMinutesSeconds(){
        ...
        assertEquals(String.format(TextChannelResponses.SEEKING_TO_INFORMATION, TimeLineStamp.timeString(10922)),
    ...
    public void seekWithMinutesSeconds(){
        ...
        assertEquals(String.format(TextChannelResponses.SEEKING_TO_INFORMATION, TimeLineStamp.timeString(122)),
                stringArgumentCaptor.getValue());
    ...
    public void seekWithSeconds(){
        ...
        assertEquals(String.format(TextChannelResponses.SEEKING_TO_INFORMATION, TimeLineStamp.timeString(2)),
                stringArgumentCaptor.getValue());
    }
