...
public class PlayCommandTest {
    ...
    public void testExecuteWhereAudioChannelNeedsToBeJoinedButCantBecauseMemberVoiceStateIsNull() {
        ...
        assertEquals(TextChannelResponse.NOT_CONNECTED_TO_VOICE_MESSAGE, stringArgumentCaptor.getValue());
    ...
    public void testExecuteWhereAudioChannelNeedsToBeJoinedButCantDueToInsufficientPermissions(){
        ...
        assertEquals(TextChannelResponse.DONT_HAVE_PERMISSION_TO_JOIN_VOICE_CHANNEL, stringArgumentCaptor.getValue());
        assertEquals(1, stringArgumentCaptor.getAllValues().size());
    }
    ...
    public void testExecuteWithNoArgument(){
        ...
        assertEquals(TextChannelResponse.NO_ARGUMENT_PROVIDED_TO_PLAY_COMMAND, stringArgumentCaptor.getValue());
    }
